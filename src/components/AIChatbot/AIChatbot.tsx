...
const AIChatbot: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "https://newsai.thedpsolutions.com/api/v1/chatbot/chat",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      {/* Chat Popup */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 left-4 sm:left-auto sm:right-6 w-auto sm:w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col z-50">
          {/* Header */}
          ...
          {/* Messages */}
          <div className="flex-1 p-3 sm:p-4 overflow-y-auto bg-gray-50 chat-messages">
            {messages.map((message) => (
              ...
              >
                ...
                <div
                  className={`min-w-0 max-w-[85%] sm:max-w-[80%] rounded-2xl p-3 ${
                    message.isUser
          ...
          <div className="p-3 sm:p-4 border-t border-gray-200">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm sm:text-base"
                disabled={isLoading}
              />
              <button
